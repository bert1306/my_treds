...
- **Чат с помощником (LLM)** в контексте пространства: вопросы по смыслу, выжимки, пересказ по загруженному контенту. Используется локальная Ollama (по умолчанию `llama3.2`).
