...
Чат по пространству и перевод по ссылкам работают через Ollama. На VPS с 2 ГБ RAM модель может не поместиться; с 4+ ГБ можно попробовать:
...
Если Ollama не ставить — приложение будет работать, но чат по пространству и перевод по ссылкам выдадут сообщение, что Ollama недоступна.
