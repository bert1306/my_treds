...
export async function POST(req: NextRequest) {
  ...
  const systemContent = `Ты помощник пользователя в приложении «my treds». Отвечай на общие вопросы. ${tzLine} Язык ответа: ${user.language === "ru" ? "русский" : "язык пользователя"}. ${langRule} ${styleHint}`;
